...
var zippyCharts = (function (exports) {
  'use strict';
  ...
  var lodash_2 = lodash.merge;

  var ChartTooltip = /** @class */ (function () {
      function ChartTooltip(chartId) {
          this.defaultTooltipWidth = 60;
          this.selector = select('body')
              .append('div')
              .attr('class', "zippy-chart-tooltip " + chartId) // TODO: implement dynamic class if needs
              .style('opacity', 0);
      }
      ChartTooltip.prototype.show = function (tooltip) {
          var tooltipWidht = tooltip && tooltip.width ? tooltip.width : this.defaultTooltipWidth;
   ...
   *
   */
  var VerticalBarChart = /** @class */ (function () {
      ...
      VerticalBarChart.prototype.init = function () {
          var _this = this;
      ...
      VerticalBarChart.prototype.redraw = function () {
          ...
          selectAll("svg#" + chartId).remove();
          var chartWidth = this.config.chartWidth || this.defaultConfig.chartWidth;
          var chartHeight = this.config.chartHeight;
          var defaultMarginLeft = 20;
          var marginLeft = this.withYLabels
              ? this.yLabelsWidth + defaultMarginLeft : defaultMarginLeft;
          // set the dimensions and margins of the graph
          var margin = { top: 30, right: 0, bottom: 30, left: marginLeft };
          var width = Math.floor(chartWidth - defaultMarginLeft - margin.right);
          var height = chartHeight - margin.top - margin.bottom;
          var tooltip = new ChartTooltip(chartId);
          ...
          var maxValue = max(data, function (d) { return d.valueX; });
          var barShift = maxValue ? maxValue.toFixed(1).length * 9 : 0;
          var x = linear$1().range([0, width - barShift]);
          var y = band().range([height, 0]);
          ...
          var xDomainMin = this.xDomainMin !== null ? this.xDomainMin : 0;
          var xDomainMax = this.xDomainMax !== 0 ? this.xDomainMax : max(data, function (d) { return d.valueX; }) || 0;
          ...
          svg.selectAll(null)
              ...
              .attr('fill', function (d, i) { return ((i + 1) % 2 === 1) ? '#faf9f7' : '#fff'; })
              .attr('y', function (d) {
              return y(d.valueY) || 0;
          })
              .attr('x', -(margin.left))
          ...
          if (this.withYLabels) {
              svg.selectAll(null)
                  ...
                  .each(function (d, i, v) { wrap(v[i], marginLeft - 5); });
              // Sub Label
              svg.selectAll(null)
                  .data(data)
                  .enter()
          ...
          svg
              ...
              var barwidth = x(d.valueX) > 2 ? x(d.valueX) : 2 - x(d.valueX) / 2;
          ...
          svg.selectAll(null)
              ...
              .attr('x', function (d, i, v) {
              var textLength = v[i].getComputedTextLength();
              var defaultPosition = x(d.valueX);
          ...
          svg
              ...
              .each(function (d, i, v) { wrap(v[i], width); })
          ...
          function wrap(textObj, maxWidth) {
              var self = select(textObj);
              var selfNode = self.node();
              if (selfNode) {
                  var textLength = selfNode.getComputedTextLength();
                  var text = self.text();
